...
public class CarAdapter extends RecyclerView.Adapter<CarAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CarAdapter.ViewHolder holder, int position) {
        ...
        } else if (cars.get(position).getMake().equals("Bugatti")){
            holder.ivMake.setImageResource(R.drawable.bugatti);

        } else if (cars.get(position).getMake().equals("Ford")){
            holder.ivMake.setImageResource(R.drawable.ford);

        } else if (cars.get(position).getMake().equals("Kia")){
            holder.ivMake.setImageResource(R.drawable.kia);

        } else if (cars.get(position).getMake().equals("Mercedes")){
            holder.ivMake.setImageResource(R.drawable.mercedes);

        }
        else if (cars.get(position).getMake().equals("Toyota")){
            holder.ivMake.setImageResource(R.drawable.toyota);

        } else if (cars.get(position).getMake().equals("Porsche")){
            holder.ivMake.setImageResource(R.drawable.porsche);
